...
export default function Personas() {
    ...
    return (
        ...
        <input className="w-full md:w-80 px-4 py-2.5 rounded-2xl bg-white border border-slate-200 outline-none focus:ring-2 focus:ring-red-300" placeholder="Buscar por nombre o email" />
